            ...
            <center>
                ...
                <div class="tabbable">
                    <ul class="nav nav-tabs">
                        <li <?php if ($activo_0 == true) {
    echo 'class="active"';
} else {
    echo 'class="disabled"';
} ?>><a href="<?php if ($activo_0 == true) {
    echo "#tab0";
} ?>" data-toggle="tab"><?php echo $language_install[2]; ?></a></li> 
                        <li <?php if ($activo_1 == true) {
    echo 'class="active"';
} else {
    echo 'class="disabled"';
} ?>><a href="<?php if ($activo_1 == true) {
    echo "#tab1";
} ?>" data-toggle="tab"><?php echo $language_install[3]; ?></a></li>
                        <li <?php if ($activo_2 == true) {
    echo 'class="active"';
} else {
    echo 'class="disabled"';
} ?>><a href="<?php if ($activo_2 == true) {
    echo "#tab2";
} ?>" data-toggle="tab"><?php echo $language_install[4]; ?></a></li>
                        <li <?php if ($activo_3 == true) {
    echo 'class="active"';
} else {
    echo 'class="disabled"';
} ?>><a href="<?php if ($activo_3 == true) {
    echo "#tab3";
} ?>" data-toggle="tab"><?php echo $language_install[5]; ?></a></li>
                        <li <?php if ($activo_4 == true) {
    echo 'class="active"';
} else {
    echo 'class="disabled"';
} ?>><a href="<?php if ($activo_4 == true) {
    echo "#tab4";
} ?>" data-toggle="tab"><?php echo $language_install[6]; ?></a></li>
                    </ul>
                    <div class="tab-content">

                        <div class="tab-pane <?php if ($activo_0 == true) {
    echo 'active';
} ?>" id="tab0">
...
<?php echo $language_install[7]; ?>:
                        ...
                        <div class="tab-pane <?php if ($activo_1 == true) {
    echo 'active';
} ?>" id="tab1">
                            <table class="table">
                                <tr>
                        ...
                        <div class="tab-pane <?php if ($activo_2 == true) {
                                            echo 'active';
                                        } ?>" id="tab2">
...
<?php echo $error_db; ?>
                        ...
                        <div class="tab-pane <?php if ($activo_3 == true) {
    echo 'active';
} ?>" id="tab3">
<?php echo $hecho_db; ?>
                        ...
                        <div class="tab-pane <?php if ($activo_4 == true) {
    echo 'active';
} ?>" id="tab4">
...
<?php echo $language_install[27]; ?>
        ...
        <script>
                                    $(function() {
                                        ...
                                        $("#form_administracion :input, #form_db :input").blur(function() {
                                            $(".text-error").html("");
                                        });
                                    });
