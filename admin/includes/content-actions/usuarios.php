...
Buscar por nick de usuario: <input type="text" name="nick_usuario" id="nick_usuario" PlaceHolder="Nick de usuario" data-provide="typeahead" data-source='[<?php echo $nicks; ?>]' data-items="8">
