      ...
      <div class="navbar-inner">
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
              <li <?php if($_GET["action"]!= "ayuda" && $_GET["action"] != "normas" && $_GET["action"] != "recuperar-1" && $_GET["action"] != "recuperar-2" && $_GET["action"] != "contacto") echo "class='active'"; ?>><a href="index.php"><?php echo $inc_navbar[0]; ?></a></li>
                    <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo $inc_navbar[1]; ?><b class="caret"></b></a>
