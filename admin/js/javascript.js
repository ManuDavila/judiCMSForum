...
{
$("#e_admin").html("No válido").addClass("text-error");
return;
}
...
{
$("#e_titulo").html("No menos de 3 caracteres ni más de 100").addClass("text-error");
return;
}
...
{
$("#e_descripcion").html("No menos de 5 caracteres ni más de 500").addClass("text-error");
return;
}
...
if (elemento.length < 5 || elemento.length > 500)
{
$("#e_keywords").html("No menos de 5 caracteres ni más de 500").addClass("text-error");
return;
}
else
{
...
{
$("#e_id_usuario").html("Error sólo números").addClass("text-error");
return;
}
else
{
