     <center>
	 <br><br>
		<span class="badge badge-success">¿QUIÉN ESTÁ CONECTADO?</span>
	<span class="badge badge-info">Usuarios navegando por este Foro: <?php echo $total_invitados; ?> invitados - <?php echo $registrados_conectados ?> registrados</span>
	</center>
	  <br><br>
	  <footer>
