...
//Consulta los datos del autor del tema
    ...
    while ($fila = $resultado->fetch_array()) {
        ...
        $mensajes .= "<div class='text-left' style='width: 80%; height: auto; border-radius: 5px; border: 1px solid #C8C8C9; padding: 10px;  margin-bottom: 10px;'>
<table class='table'>
<tr>
...
" . html_entity_decode($fila["mensaje"]) . " 
<br><br>
...
$leyenda_usuario
    ...
    <br>
    <div class='text-left' style='width: 80%; height: auto; border-radius: 5px; border: 1px solid #C8C8C9; padding: 10px; margin-bottom: 10px;'>
        <table class="table">
            <tr>
                <td>
